          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 mb-4 customize-wrap wow fadeInUp">
              <div class="customize-item">
                ...
                <div class="customize-ct">
                  <h4>
                    <a href="event-detail.php">TED TALKS AT UCF COLLEGE OF EDUCATION</a>
                  </h4>
                </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4 customize-wrap wow fadeInUp">
              <div class="customize-item">
                ...
                <div class="customize-ct">
                  <h4>
                    <a href="event-detail.php">IMPORTANCES OF RESEARCH SEMINAR 2021</a>
                  </h4>
                </div>
                <div class="customize-bottom">
                  <ul class="d-flex justify-content-start">
            ...
            <div class="col-lg-4 col-md-6 mb-4 customize-wrap wow fadeInUp">
              <div class="customize-item">
                ...
                <div class="customize-ct">
                  <h4>
                    <a href="event-detail.php">NEWLY SUMMER COURSE STARTS FROM JUNE</a>
                  </h4>
                </div>
                <div class="customize-bottom">
                  <ul class="d-flex justify-content-start">

          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 customize-wrap mb-4 wow fadeInUp">
              <div class="customize-item">
                ...
                <div class="customize-ct">
                  <h4>
                    <a href="course-detail.php">DIGITAL MARKETING | SOCIAL MEDIA MARKETING BUSINESS</a>
                  </h4>
            ...
            <div class="col-lg-4 col-md-6 customize-wrap mb-4 wow fadeInUp">
              <div class="customize-item">
                ...
                <div class="customize-ct">
                  <h4>
                    <a href="course-detail.php">BUILD BRAND INTO MARKETING: TACKLING NEW MARKETING</a>
                  </h4>
                  <div class="review-ct d-flex justify-content-start">
                    <a href="#">21 Reviews</a>
                    <ul class="ml-2">
            ...
            <div class="col-lg-4 col-md-6 customize-wrap mb-4 wow fadeInUp">
              <div class="customize-item">
                ...
                <div class="customize-ct">
                  <h4>
                    <a href="course-detail.php">CULTURE & STRATEGIES FOR A SUCCESSFUL BUSINESS</a>
                  </h4>
                  <div class="review-ct d-flex justify-content-start">
                    <a href="#">21 Reviews</a>
                    <ul class="ml-2">
            ...
            <div class="col-lg-4 col-md-6 customize-wrap mb-4 wow fadeInUp">
              <div class="customize-item">
                ...
                <div class="customize-ct">
                  <h4>
                    <a href="course-detail.php">GROW YOUR BUSINESS BY MASTERED IN SOME TECHNIQUE</a>
                  </h4>
                  <div class="review-ct d-flex justify-content-start">
                    <a href="#">21 Reviews</a>
                    <ul class="ml-2">
            ...
            <div class="col-lg-4 col-md-6 customize-wrap mb-4 wow fadeInUp">
              <div class="customize-item">
                ...
                <div class="customize-ct">
                  <h4>
                    <a href="course-detail.php">GROW UP AUDIENCE TO PROGRESS BUSINESS</a>
                  </h4>
                  <div class="review-ct d-flex justify-content-start">
                    <a href="#">21 Reviews</a>
                    <ul class="ml-2">
            ...
            <div class="col-lg-4 col-md-6 customize-wrap mb-4 wow fadeInUp">
              <div class="customize-item">
                ...
                <div class="customize-ct">
                  <h4>
                    <a href="course-detail.php">JAVA PROGRAMMING A-Z FULLY CLASSES WITH FULL TASK</a>
                  </h4>
                  <div class="review-ct d-flex justify-content-start">
                    <a href="#">21 Reviews</a>
                    <ul class="ml-2">

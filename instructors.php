        ...
        <div class="row instruct-main wow fadeInLeft">
          ...
          <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="ins-main-list mt-5">
              <img src="assets/images/team/test-1.jpg" alt="" />
              <div class="ins-names">
                <h4>William Smith</h4>
                <span class="cl-orange">CEO / Founder</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="ins-main-list mt-5">
              <img src="assets/images/team/test-2.jpg" alt="" />
              <div class="ins-names">
                <h4>Nicole Kiyl</h4>
                <span class="cl-orange">Project Manager</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="ins-main-list mt-5">
              <img src="assets/images/team/test-3.jpg" alt="" />
              <div class="ins-names">
                <h4>John Melton</h4>
                <span class="cl-orange">Instructor</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="ins-main-list mt-5">
              <img src="assets/images/team/test-5.jpg" alt="" />
              <div class="ins-names">
                <h4>Ketti Helson</h4>
                <span class="cl-orange">Business Analyst</span>
              </div>
